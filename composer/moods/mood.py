...
class MoodLibrary:
    ...
    MOODS: dict[str, Mood] = {
        ...
        "mystic": Mood(
            name="mystic",
            preferred_modes=["whole_tone", "lydian", "phrygian", "double_harmonic"],
            tempo_range=(60, 95),
            velocity_range=("pp", "mp"),
            intensity=0.4,
            preferred_contours=["wave", "plateau"],
            ...
            preferred_acc_styles=["pad", "arpeggio"],
            dynamic_curve="wave",
            description="Arcane, spiritual, otherworldly",
        ),
        "heavenly": Mood(
            name="heavenly",
            preferred_modes=["lydian", "major", "pentatonic_major"],
            ...
            velocity_range=("pp", "p"),
            intensity=0.3,
            preferred_contours=["ascending", "plateau"],
            preferred_bass_styles=["pedal"],
            preferred_acc_styles=["pad", "arpeggio"],
            dynamic_curve="crescendo",
            description="Divine, angelic, celestial",
        ),
        "neutral": Mood(
            name="neutral",
            preferred_modes=["major"],
